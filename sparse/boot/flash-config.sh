...
"flash_blob oem_a *_v9_ganges.img"
)
...
https://opendevices.sony.net/file/download/software-binaries-for-aosp-pie-android-9-0-kernel-4-9-ganges
Ensure you download the supported version of the image found under:
\"Software binaries for AOSP Pie (Android 9.0) - Kernel 4.9 - Ganges\"
